"""
Django settings for small_snowflake_44503 project.
...
ROOT_URLCONF = 'small_snowflake_44503.urls'
...
WSGI_APPLICATION = 'small_snowflake_44503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_snowflake_44503 API",
    "DESCRIPTION": "API documentation for small_snowflake_44503 App",
    "VERSION": "v1",
}
